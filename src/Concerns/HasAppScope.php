...
trait HasAppScope
{
    ...
    /**
     * When using mechanism for HasContainer, they inherit name of the
     ...
     * so HasContainer contains a mechanism for auto-shortening the
     * name based around max_name_length. The mechanism does only work
     * if HasAppScope is used, $app property is set and has a
