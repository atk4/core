...
trait HasDynamicMethods
{
    ...
    {
        if (!$this->hasGlobalMethodAccess()) {
            throw new Exception(['Object has no access to global methods']);
        }
    ...
    {
        return $this->hasGlobalMethodAccess() && $this->app->hookHasCallbacks('global-method-'.$name);
    }
    ...
    /**
     * Checks if current object can manuipulate global methods
     * HasAppScope trait and HasHooks trait for app are mandatory
     * 
     * @return boolean
     */
    protected function hasGlobalMethodAccess()
    {
        return $this->disposition(HasAppScope::class) && $this->dispositionOf($this->app, HasHooks::class);
    }
}
